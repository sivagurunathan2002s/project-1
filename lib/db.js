...
export async function initDB() {
  ...
  await sql`CREATE TABLE IF NOT EXISTS order_items (id SERIAL PRIMARY KEY, order_id INTEGER NOT NULL REFERENCES orders(id), product_id INTEGER REFERENCES products(id) ON DELETE SET NULL, quantity_bought INTEGER NOT NULL, price_at_sale NUMERIC(10,2) NOT NULL)`;
}
